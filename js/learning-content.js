...
window.ATHANAS_LEARNING_CONTENT = {
  ...
  updated: "2026-07-29",
  latestUpdates: [
    { type: "tool", icon: "▦", title: "QR Code Generator", summary: "Create customised QR codes with a searchable builder, optional poster text, a premium A4 output, and QR-only downloads.", url: "/digital-tools/qr-code-generator.html", date: "2026-07-29", dateLabel: "29 July 2026" },
  ...
  tools: [
    { id: "quiz", title: "General ICT Quiz Game", description: "Practise computer basics, Word, Excel, internet safety, shortcuts, and beginner ICT skills with instant feedback.", icon: "🎮", url: "/digital-tools/ict-quiz.html", category: "learn-practise", status: "available", level: "Beginner", purpose: "Knowledge practice" },
    { id: "shortcuts", title: "Computer Shortcut Keys Trainer", description: "Train Windows, Word, Excel, browser, and common keyboard shortcuts with instant correction.", icon: "⌨️", url: "/digital-tools/shortcut-keys-trainer.html", category: "learn-practise", status: "available", level: "Beginner", purpose: "Speed and productivity" },
    { id: "typing", title: "Typing Speed Trainer", description: "Improve typing speed, accuracy, focus, and ICT vocabulary through timed practice.", icon: "⚡", url: "/digital-tools/typing-trainer.html", category: "learn-practise", status: "available", level: "All levels", purpose: "Typing confidence" },
    { id: "calculator", title: "Scientific Calculator", description: "Use a practical calculator for school mathematics, science, percentages, powers, roots, and trigonometry.", icon: "🧮", url: "/digital-tools/scientific-calculator.html", category: "calculate", status: "available", level: "All levels", purpose: "Calculations" },
    { id: "qr", title: "QR Code Generator", description: "Create customised QR codes with a live portrait poster preview, optional top and bottom text, A4 PDF or PNG export, and a QR-only PNG.", icon: "▦", url: "/digital-tools/qr-code-generator.html", category: "create", status: "available", level: "All levels", purpose: "Create and share" },
  ...
  pages: [
    ...
    { id: "tools", category: "Page", title: "Digital Tools", description: "Open the QR Code Generator, ICT quiz, shortcut trainer, typing trainer, and scientific calculator.", url: "/digital-tools/index.html", keywords: "tools qr code generator quiz shortcut typing calculator" },
    { id: "quiz-page", category: "Digital Tool", title: "General ICT Quiz Game", description: "Test computer basics, Microsoft Word, Excel, internet safety, and general ICT knowledge.", url: "/digital-tools/ict-quiz.html", keywords: "quiz ICT game questions test" },
    { id: "shortcuts-page", category: "Digital Tool", title: "Computer Shortcut Keys Trainer", description: "Practise useful Windows, Word, Excel, browser, and general keyboard shortcuts.", url: "/digital-tools/shortcut-keys-trainer.html", keywords: "keyboard shortcuts ctrl trainer" },
    { id: "typing-page", category: "Digital Tool", title: "Typing Speed Trainer", description: "Improve typing speed and accuracy through timed beginner-friendly practice.", url: "/digital-tools/typing-trainer.html", keywords: "typing speed accuracy keyboard practice" },
    { id: "calculator-page", category: "Digital Tool", title: "Scientific Calculator", description: "Complete everyday and scientific calculations directly in the browser.", url: "/digital-tools/scientific-calculator.html", keywords: "calculator mathematics science percentages roots" },
    { id: "qr-generator-page", category: "Digital Tool", title: "QR Code Generator", description: "Create, customise, test, and download QR codes with optional poster text, premium A4 PDF or PNG output, and a clean QR-only PNG.", url: "/digital-tools/qr-code-generator.html", keywords: "qr code generator website whatsapp wifi contact payment poster text a4 pdf png qr only print" },
